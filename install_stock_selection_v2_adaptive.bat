...
cd /d "%~dp0"
echo ==========================================================================================
echo APlus Stock Selection V2 - Adaptive Compatible Installer
echo PRESERVES CURRENT ACTIONABLE LOGIC + API RELIABILITY - PAPER ONLY
echo ==========================================================================================
python install_stock_selection_v2_adaptive.py
if errorlevel 1 (
  echo.
...
echo.
python verify_stock_selection_v2_adaptive.py
if errorlevel 1 (
  echo.

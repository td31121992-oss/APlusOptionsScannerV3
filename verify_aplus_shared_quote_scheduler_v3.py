...
checks={
"v3_marker":"APLUS_SHARED_QUOTE_SCHEDULER_V3" in s,
"nse_eq":'"NSE_EQ": [item.security_id for item in universe]' in s,
"nse_fno":'quote_request["NSE_FNO"] = open_option_ids' in s,
"shared_update":"_monitor_paper_positions_from_quote_map" in s,
...
print("="*112)
print("APLUS DHAN 429 RELIABILITY V3 VERIFY")

...
cd /d "%~dp0"
echo ======================================================================================================================
echo APlus Pending Work - One Go V3
echo AST-BASED ADAPTIVE INSTALLER - PAPER ONLY - NO LIVE ORDERS
echo ======================================================================================================================
echo [1/5] Install permanent paper-trade history + dashboard V3...
python install_paper_trade_history_dashboard_v3.py

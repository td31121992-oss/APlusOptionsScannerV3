...
HTML = '''<!doctype html>
<html><head><meta charset="utf-8"><title>APlus Paper Trading Live P&L</title>
<style>
...
<div class="header"><div><div class="title">APlus PAPER Live P&L Dashboard</div><div class="sub">Auto-refreshes every 5 seconds from data/reports</div></div><div class="sub">Last update: <span id="updated">-</span></div></div>
<div class="grid">
...
def main():
    print("="*72)
    print("APlus PAPER Live P&L Dashboard")
